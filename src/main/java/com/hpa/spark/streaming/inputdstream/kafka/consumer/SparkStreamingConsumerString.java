 ...
 */
public class SparkStreamingConsumerString {
    public static void main(String[] args)throws Exception{
        SparkConf sparkConf = new SparkConf();

        sparkConf.setAppName("Object");
        ...
        if("local[2]".equals(args[0])){
            ...
            sparkConf.setJars(new String[]{"../Object.jar",
        ...
        JavaDStream<String> value = stream.map(new Function<Tuple2<String,String>, String>() {

            public String call(Tuple2<String, String> stringStudentTuple2) throws Exception {
                return "student:" + stringStudentTuple2._2() + "!";
            }
        });
